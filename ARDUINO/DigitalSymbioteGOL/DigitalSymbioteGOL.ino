...
///////////////  Name: MEGAN BATES                                       ///////////////
///////////////                                                          ///////////////
///////////////  Digital Symbiote (GOL)                                  ///////////////
///////////////  To to be booted on an ATMega installed on custom        ///////////////
///////////////  circuit boards 'Hardware GOL' 1,2 & 3                   ///////////////
///////////////                                                          ///////////////
///////////////  Arduino Trigger code connects to a relay which          ///////////////
///////////////  refreshes this GOL program using signals from plants.   ///////////////
///////////////  This causes intermittent, organic changes of the        ///////////////
///////////////  activity level of the LEDs- triggered by the plants.    ///////////////
///////////////  Without the plant, activity levels will not be high     ///////////////
///////////////  enough for the GOL to refresh and the LEDs will be      ///////////////
///////////////  static.                                                 ///////////////
///////////////                                                          ///////////////
///////////////                                                          ///////////////
///////////////  References:                                             ///////////////
///////////////  1: John Horton Conway's 'Game Of Life' Gardner, Martin  ///////////////
///////////////  (October 1970). "Mathematical Games – The fantastic     ///////////////
///////////////  combinations of John Conway's new solitaire game        ///////////////
///////////////  "life"". Scientific American. 223: 120–123.             ///////////////
///////////////  2: https://processing.org/examples/gameoflife.html      ///////////////
...
///////////////  3: https://pastebin.com/f22bfe98d                       ///////////////
///////////////  Correct method for multiplexing an LED matrix using     ///////////////
///////////////  the arduino FrequencyTimer library.                     ///////////////
///////////////  4: https://www.arduino.cc/en/Tutorial/                  ///////////////
///////////////  ArduinoToBreadboard ATMega bootloading method           ///////////////
///////////////                                                          ///////////////
////////////////////////////////////////////////////////////////////////////////////////
...
// Keeps track of where we are in the columns of LEDs for multiplexing
int columnCounter = 0;
