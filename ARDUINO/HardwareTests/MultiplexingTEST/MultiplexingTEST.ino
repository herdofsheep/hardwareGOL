...
void setupLeds() {
  ...
  // Turn off toggling of pin 11 and 3, we don't need it.
  FrequencyTimer2::disable();
  // Set refresh rate IN HERTZ- 10000 gives very quick wraparound, but lights flash. 100, slow wraparound, stable lights.
  FrequencyTimer2::setPeriod(5000);
  // Every refreshrate, call the display function.
