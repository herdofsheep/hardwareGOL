...
int columnCounter = 0;
//keeps track of how long the delay between GOL calls needs to be
...
void setupLeds() {
  ...
  FrequencyTimer2::setPeriod(33333);
  // Set interrupt routine to be called
  FrequencyTimer2::setOnOverflow(GOLCall);
